...
if args.LOO == True:
	fileout1 = open('../corpora_and_texts_obtained/2gm_{}_merge_75000_leaveone'.format(lang),'w',encoding = 'utf-8')
else:
	fileout1 = open('../corpora_and_texts_obtained/2gm_{}_merge_75000'.format(lang),'w',encoding = 'utf-8')
...
if args.LOO == True:
	inp = '../corpora_and_texts_obtained/2gm_{}_merge_75000_leaveone'.format(lang)
else:
	inp = '../corpora_and_texts_obtained/2gm_{}_merge_75000'.format(lang)
file1 = open(inp, 'rb')
