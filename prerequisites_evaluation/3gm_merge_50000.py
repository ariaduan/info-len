...
p = ArgumentParser()
p.add_argument("input_folder", type = Path) # '/om/data/public/corpora/google_web_ngrams/data/3gms'
...
if args.LOO == True:
	fileout1 = open('../corpora_and_texts_obtained/3gm_{}_merge_50000_leaveone'.format(lang),'w',encoding = 'utf-8')
else:
	fileout1 = open('../corpora_and_texts_obtained/3gm_{}_merge_50000'.format(lang),'w',encoding = 'utf-8')
...
if args.LOO == True:
	inp = '../corpora_and_texts_obtained/3gm_{}_merge_50000_leaveone'.format(lang)
else:
	inp = '../corpora_and_texts_obtained/3gm_{}_merge_50000'.format(lang)
file1 = open(inp, 'rb')
