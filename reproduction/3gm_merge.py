...
if args.LOO == True:
	fileout1 = open('../corpora_and_texts_obtained/3gm_{}_merge_leaveone'.format(lang),'w',encoding = 'utf-8')
else:
	fileout1 = open('../corpora_and_texts_obtained/3gm_{}_merge'.format(lang),'w',encoding = 'utf-8')
...
if args.LOO == True:
	inp = '../corpora_and_texts_obtained/3gm_{}_merge_leaveone'.format(lang)
else:
	inp = '../corpora_and_texts_obtained/3gm_{}_merge'.format(lang)
file1 = open(inp, 'rb')
