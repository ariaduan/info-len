...
fileout1 = open('../corpora_and_texts_obtained/3gm_info_freq','w',encoding = 'utf-8')
fileout2 = open('../corpora_and_texts_obtained/3gm_for_gaussian_test','w',encoding = 'utf-8')
fileout3 = open('../corpora_and_texts_obtained/3gm_POS_for_gaussian_test','w',encoding = 'utf-8')
fileout4 = open('../corpora_and_texts_obtained/3gm_pho_syl_len','w',encoding = 'utf-8')
fileout5 = open('../corpora_and_texts_obtained/3gm_POS_info_freq','w',encoding = 'utf-8')
