...
Analysis:  
In this section, we analyse the validity and generalization ability of this work.  
  
#####################  
  
Experience:  
In this section, I listed some useful tools and lessons I learned from this project in a tree format.  
...
>	>	>	|------>	wikipedia  
>	>	|------>	syntactic structure  
>	>	>	|------>	universal-dependency(multilingual)  
>	>	|------>	parallel texts  
>	>	>	|------>	OPUS OpenSubtitles(multilingual)  
>	>	|------>	phoneme  
>	>	>	|------>	CMU  
>	>	|------>	syllable  
>	>	>	|------>	celex>	>	  
...
>	>	|------>	work documentation  
>	>	>	|------>	schemes  
>	>	>	>	|------>	specify every defination in math at the beginning or you will get in trouble later  
>	>	>	>	|------>	ask all the silly questions as soon as possible or you will get in trouble later  
>	>	>	|------>	timeline  
>	>	>	>	|------>	set deadline or you will do nothing  
>	>	>	|------>	readme.md  
>	>	>	>	|------>	document what you have done as soon as possible or you will never understand your program a month later  
>	>	>	|------>	problems and next step  
>	>	>	>	|------>	write down the next step once you finish the present work or you will forget things are not done yet  
>	>	>	|------>	resourses and usage  
>	>	>	>	|------>	corpora----|  
>	>	>	>	|------>	softwares  |-----remember where to find and how to use them or start from scratch a month later  
>	>	>	>	|------>	packages   |  
>	>	>	>	|------>	commands---|  
>	>	>	|------>	skills and habits  
>	>	>	>	|------>	don't think they are already in your long-term memory when they are actully in your working memory '   
>	>	|------>	codes format  
>	>	>	|------>	tidiness  
>	>	>	>	|------>	argparse together with readme.md  
>	>	>	>	|----->	partition the codes accoding to their use  
>	>	>	|------>	progress bar  
>	>	>	>	|------>	tqdm  
>	>	>	|------>	optimization  
...
R section  
plot -- web -- n234 & -- book -- n24  
leave one out -- book -- n3 ::  
no leave one out -- web -- n234 √  
leave one out -- 5000 web n234 √  
RNN -- 30k 15k 5k ::  
plot  
